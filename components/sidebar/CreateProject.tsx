...
export default function CreateProject() {
	return (
		<div className='w-full flex items-center gap-2 rounded-md p-2 hover:bg-neutral-100 transition-colors group justify-between cursor-pointer dark:hover:bg-neutral-700 '>
